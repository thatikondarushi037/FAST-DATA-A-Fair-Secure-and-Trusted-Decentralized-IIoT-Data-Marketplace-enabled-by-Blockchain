...
<head>
<title>Publisher Users Profile</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>  <span class="style3"><span class="style3">User</span> <%=request.getParameter("type1")%>'s Profile</span></h2>
	  ...
	  <h2>&nbsp;</h2>
            ...
            <h2 align="right"><a href="P_EntityComments.jsp?id=<%=id%>" class="style4">Back</a></h2>
			<%}else if(type.equalsIgnoreCase("user2")){%>
            <h2 align="right"><a href="P_MyEntityDetails.jsp?id=<%=id%>" class="style4">Back</a></h2>
			<%}
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu"><li><span class="style2"><a href="P_Main.jsp"> Home</a></span></li>
