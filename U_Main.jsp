...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3">Wel-Come Client:: <%=(String)application.getAttribute("uname")%></span></h2>
          <p><img src="images/User.jpg" width="616" height="300" /></p>
          <div class="clr"></div>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu style2">
            <li class="style4"><a href="U_Profile.jsp">My Profile</a></li>
			<li class="style4"><a href="U_Purchase_req.jsp">Request Data Purchase</a></li>
			
			<li class="style4"><a href="U_Find_Data_Details.jsp">Find Data Details</a></li>
			<li class="style4"><a href="U_Find_DataDetails_By_Blockchain_Hashcode.jsp">Find Data Details By Blockchain Hashcode</a></li>
            <li class="style4"><a href="U_Login.jsp">LogOut</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
