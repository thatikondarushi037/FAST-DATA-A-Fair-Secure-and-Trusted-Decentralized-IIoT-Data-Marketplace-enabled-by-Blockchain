...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <h2> <span class="style3">Welcome to Publisher Register Form</span> </h2>
            ...
            <table width="517" height="459" border="0" cellpadding="2" cellspacing="2">
              <tr>
                <td width="126"><span class="style33 style6 style3">
                  <label for="User"><strong>Publisher Name *</strong></label>
                </span></td>
            ...
            <p align="right"><a href="P_Login.jsp" class="style3"><strong>Back</strong></a></p>
          </form>
