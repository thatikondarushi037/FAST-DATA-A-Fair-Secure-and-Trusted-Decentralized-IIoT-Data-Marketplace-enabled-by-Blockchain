...
<div class="main">
    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="AdminLogin.jsp">Storage </a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="logo">
        <h1 class="style4"><a href="#" class="style65">FAST DATA A Fair, Secure and Trusted Decentralized IIoT Data Marketplace enabled by Blockchain</a></h1>
      </div>
  ...
  <div class="content">
    <div class="content_resize">
          ...
          <h2><span class="style33 style33 style43">View All Stored Datasets By City Blockchain !!! </span></h2>
          <div class="clr"></div>
          
        
            <p>&nbsp;</p>
            <iframe width="900" height="700" src="A_View_All_Datasets_By_City_Blockchain1.jsp"></iframe>
            <p>&nbsp;</p>
