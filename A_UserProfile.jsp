...
<head>
<title>Admin Users Profiles</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3">Client <%=request.getParameter("type1")%>'s Profile</span></h2>
	  ...
	  <h2>&nbsp;</h2>
            ...
            <h2 align="right"><a href="A_SearchKeyword.jsp" class="style4">Back</a></h2>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><span class="style2"><a href="A_Main.jsp">Admin Home</a></span></li>
