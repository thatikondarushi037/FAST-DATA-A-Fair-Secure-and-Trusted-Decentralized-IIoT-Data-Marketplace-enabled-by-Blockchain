...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3">Client Registration Status</span></h2>
...
else
{
            ...
            <br />
            <br />
            <p align="center" class="style24 style31 style4">Client Name Already Exist..</p>
            <br />
...
PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,address,dob,gender,status,image) values(?,?,?,?,?,?,?,?,?)");
            ...
            <br/>
            <p align="center" class="style42 style25 style32 style5">Registration Successful..</p>
            <br />
