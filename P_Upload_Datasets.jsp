...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1 class="style4">FAST DATA: A Fair, Secure and Trusted Decentralized IIoT Data Marketplace enabled by Blockchain</h1>
      </div>
      <div class="menu_nav">
        <ul>
    ...
    <div class="content_resize">
      <div class="mainbar">
	   ...
	   <h2 class="style10">Upload Datasets !!! </h2>
		  ...
		  <form name="vinform" action="P_Upload_Datasets1.jsp" method="post" id ="firstForm"> 
            <table width="424">
              <tr>
