...
<head>
<title>Admin Publisher Profile</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3">Seller <%=request.getParameter("pname")%>'s Profile</span></h2>
         <table width="533" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
            <%@ include file="connect.jsp" %>
            
            <%
						String publish=request.getParameter("pname");
						
						String s1,s2,s3,s4,s5,s6;
						int i=0;
						try 
						{
						   	String query="select * from publisher where username='"+publish+"'"; 
		  ...
		  <% String type=request.getParameter("type");
			...
			if(type.equalsIgnoreCase("rtree")){%>
            <h2 align="right"><a href="A_EntityDetails.jsp?id=<%=id%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}else if(type.equalsIgnoreCase("search")){%>
            <h2 align="right"><a href="A_EntityDetails.jsp?id=<%=id%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("allentity")){%>
            <h2 align="right"><a href="A_EntityDetails.jsp?id=<%=id%>&type=<%=type%>" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("allentity1")){%>
            <h2 align="right"><a href="A_AllEntity.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("allentity2")){%>
            <h2 align="right"><a href="A_SematicSimilar.jsp" class="style4">Back</a></h2>
			<%}
			else if(type.equalsIgnoreCase("entitychart")){%>
            <h2 align="right"><a href="A_EntityChart.jsp" class="style4">Back</a></h2>
			<%}
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu"><li><span class="style2"><a href="A_Main.jsp"> Home</a></span></li>
            <li class="style2"><a href="A_Login.jsp">LogOut</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
