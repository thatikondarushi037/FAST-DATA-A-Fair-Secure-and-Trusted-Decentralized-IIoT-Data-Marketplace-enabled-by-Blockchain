...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
            <h2><span class="style3">Welcome to Seller Login</span></h2>
		    <form name="s" action="Authentication.jsp?value=<%="publisherlogin"%>" method="post" onSubmit="return valid()"  ons target="_top">
		 <table width="660" align="left">
          ...
          <td>
                 ...
                 New User?</span><a href="P_Register.jsp" class="style21"> Register </a></td>
		      </tr>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li class="style2"><a href="P_Login.jsp">Seller</a></li>
            <li class="style2"><a href="A_Login.jsp">Storage Operatos </a></li>
            <li><span class="style2"><a href="U_Login.jsp">Client</a></span></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
